...
class SceneGenMoviesNode:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "gemini_api_key": ("STRING", {"multiline": False, "default": "Your_Api_key_Here", "tooltip": "Your Google Gemini API Key. Required for analysis and prompt generation."}),
                "replicate_api_token": ("STRING", {"multiline": False, "default": "Your_Api_key_Here", "tooltip": "Your Replicate API Token. Required for video generation models."}),
                ...
                "creativity": ("FLOAT", {"default": 0.8, "min": 0.0, "max": 1.0, "step": 0.1, "tooltip": "0.0 = Strict adherence to prompt. 1.0 = High hallucination/creative freedom."}),
                "dynamicity": ("FLOAT", {"default": 0.7, "min": 0.0, "max": 1.0, "step": 0.1, "tooltip": "0.0 = Slow, static, contemplative shots. 1.0 = Fast cuts, high movement, intense action."}),
                ...
                "save_segments": ("BOOLEAN", {"default": True, "tooltip": "If True, saves every individual video clip generated by Replicate to the output folder."}),
                "save_images": ("BOOLEAN", {"default": True, "tooltip": "If True, saves the start frame images generated by Gemini."}),
                "save_assets": ("BOOLEAN", {"default": True, "tooltip": "If True, saves the generated asset images (characters, props, environments)."}),
                "gemini_concurrency": ("INT", {"default": 10, "min": 1, "max": 50, "tooltip": "Max parallel requests to Gemini API."}),
                "replicate_concurrency": ("INT", {"default": 15, "min": 1, "max": 50, "tooltip": "Max parallel video generation jobs on Replicate."}),
                "use_wan_fast": ("BOOLEAN", {"default": False, "tooltip": "Enable Wan 2.5 Fast model."}),
                "use_wan_2_5": ("BOOLEAN", {"default": False, "tooltip": "Enable Wan 2.5 Standard model."}),
                "use_kling_turbo": ("BOOLEAN", {"default": False, "tooltip": "Enable Kling v2.5 Turbo model."}),
                "use_omni_human": ("BOOLEAN", {"default": False, "tooltip": "Enable OmniHuman model (good for realistic human movement)."}),
                "use_hailuo": ("BOOLEAN", {"default": False, "tooltip": "Enable Hailuo 2.3 model."}),
                "use_hailuo_fast": ("BOOLEAN", {"default": True, "tooltip": "Enable Hailuo 2.3 Fast model."}),
                "use_veo_3_1": ("BOOLEAN", {"default": False, "tooltip": "Enable Google Veo 3.1 model."}),
                "use_veo_3_1_fast": ("BOOLEAN", {"default": False, "tooltip": "Enable Google Veo 3.1 Fast model."}),
                "aggressive_edit": ("BOOLEAN", {"default": True, "tooltip": "If True, forces fast-paced editing with cuts strictly on beat. Generates full clips but trims them aggressively."}),
                "word_influence": ("FLOAT", {"default": 0.7, "min": -1.0, "max": 1.0, "step": 0.1, "tooltip": "1.0 = Literal visualization of lyrics. -1.0 = Ignore lyrics, focus on vibe/atmosphere. 0.0 = Balanced."}),
                ...
                "mix_native_audio": ("BOOLEAN", {"default": False, "tooltip": "If True, mixes the audio generated by the video models (if any) with the input audio."}),
                ...
                "api_timeout": ("INT", {"default": 280, "min": 60, "max": 600, "tooltip": "Timeout in seconds for all Gemini API calls across all stages. Default: 280 seconds (4.5 minutes)."}),
            },
            "optional": {
    ...
    def process(self, audio, gemini_api_key, replicate_api_token, prompt_instruction, filename_prefix, fps, model_text, model_image, creativity, dynamicity, video_quality, aspect_ratio, resolution_multiplier, enable_prompt_expansion, save_segments, save_images, save_assets, gemini_concurrency, replicate_concurrency, use_wan_fast, use_wan_2_5, use_kling_turbo, use_omni_human, use_hailuo, use_hailuo_fast, use_veo_3_1, use_veo_3_1_fast, aggressive_edit, word_influence, save_edl, open_coffee_link, render_mode, dialogues_gen, open_report, mix_native_audio, audio_volume, video_volume, normalize_audio, use_raw_references, verification_iterations, api_timeout, reference_images=None):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            future = executor.submit(asyncio.run, self.async_process(
                ...
                mix_native_audio, audio_volume, video_volume, normalize_audio, use_raw_references, verification_iterations, api_timeout
            ))
    ...
    async def async_process(self, audio_data, sample_rate, instruction, prefix, session_dir, fps, model_text_name, model_image_name, creativity, dynamicity, video_quality, aspect_ratio, resolution_multiplier, enable_prompt_expansion, save_segments, save_images, save_assets, gemini_concurrency, replicate_concurrency, use_wan_fast, use_wan_2_5, use_kling_turbo, use_omni_human, use_hailuo, use_hailuo_fast, use_veo_3_1, use_veo_3_1_fast, aggressive_edit, word_influence, save_edl, ref_images_pil, render_mode, dialogues_gen, open_report, mix_native_audio, audio_volume, video_volume, normalize_audio, use_raw_references, verification_iterations, api_timeout):
    ...
    <div class="container">
        <header>
            <div class="header-content">
                ...
                <div class="gh-links">
                    <a href="https://www.youtube.com/channel/UCHotSlu3SDgp35lat92ExIQ" target="_blank" class="gh-btn" style="background: rgba(255,0,0,0.2); border-color: rgba(255,0,0,0.4);">📺 YouTube</a>
                    <a href="https://github.com/lazniak/scene_gen" target="_blank" class="gh-btn">⭐ Star on GitHub</a>
                    <a href="https://github.com/lazniak" target="_blank" class="gh-btn">👤 Follow @lazniak</a>
                </div>
            </div>
        </header>
...
"""        
        ...
        # Stage 1 with timeout and retry logic
        max_retries_s1 = 3
        resp_s1 = None
        debug_s1 = None
        for attempt in range(max_retries_s1):
            try:
                print(f"[SceneGen] Stage 1: Sending request to Gemini (Attempt {attempt+1}/{max_retries_s1})...")
                update_report("Stage 1: Analyzing Audio...", 5, f"Sending audio to Gemini for analysis... (Attempt {attempt+1}/{max_retries_s1})")
                # Use timeout for audio analysis (longer timeout due to audio processing)
                resp_s1 = await asyncio.wait_for(
        ...
        debug_s1 = resp_s1.text
                ...
                print(f"[SceneGen] Stage 1: Timeout error (Attempt {attempt+1}/{max_retries_s1}). Audio analysis is taking longer than expected...")
                if attempt == max_retries_s1 - 1:
                    raise Exception("Stage 1: Audio analysis timed out after 3 attempts. The audio file might be too large or there's a connection issue.")
                await asyncio.sleep(5 * (attempt + 1))  # Exponential backoff
            except Exception as e:
                print(f"[SceneGen] Stage 1 Error (Attempt {attempt+1}/{max_retries_s1}): {e}")
                if attempt == max_retries_s1 - 1:
                    raise Exception(f"Stage 1: Failed to analyze audio after {max_retries_s1} attempts: {str(e)}")
                await asyncio.sleep(5 * (attempt + 1))  # Exponential backoff
        track_text("", debug_s1)
        track_text("", debug_s1)
        ...
        for attempt in range(max_retries_s2):
            try:
                resp_s2 = await asyncio.wait_for(
                    model_text.generate_content_async(prompt_s2),
                    timeout=api_timeout
                )
                break
            except Exception as e:
        ...
        # --- STAGE 2.5: Reference Analysis ---
        print("[SceneGen] Stage 2.5: Reference Analysis...")
        ref_data = []
        ...
        if ref_images_pil:
            prompt_s3_5 = f"""
            CRITICAL TASK: Analyze the attached {len(ref_images_pil)} reference images in context of the user's instruction and project style.
            
            User Instruction: "{instruction}"
            Style: "{style_instruction}"
            
            IMPORTANT INSTRUCTIONS:
            1. **Actor/Character Identification**: 
               - If the user instruction mentions using a specific person (e.g., "Use this man as host", "this elegant man", "this person as presenter"), identify them as an ACTOR.
               - Extract the ROLE from the instruction (e.g., "Host", "Presenter", "Main_Character").
               - Provide a detailed visual description focusing on: age, gender, facial features, hair style/color, clothing style, expression.
            
            2. **Category Assignment**:
               - "Actor": Any person, character, animal, or sentient being.
               - "Prop": Objects, vehicles, items, tools.
               - "Environment": Locations, backgrounds, settings, scenery.
            
            3. **Naming Convention**:
               - Use descriptive, unique names based on the role/function mentioned in the instruction.
               - Examples: "Host_Man", "Presenter_Elegant", "Car_Jaguar", "Location_Studio"
               - If no role is mentioned, use generic but descriptive names like "Man_Suit", "Woman_Blonde", "Car_Silver"
            
            4. **Visual Description**:
               - Be extremely detailed and specific.
               - For actors: describe everything that makes them unique and recognizable.
               - Focus on features that will help recreate/use this person in generated scenes.
            
            Return JSON object with "references": list of objects:
            - "index": int (0-based index of the image in the provided list)
            - "category": string ("Actor", "Prop", or "Environment")
            - "name": string (unique identifier based on role/description)
            ...
            {{
              "references": [
                {{
                  ...
                  "category": "Actor",
                  "name": "Host_Man",
                  "description": "Middle-aged man in his 40s with short brown hair, wearing a dark blue suit jacket, white shirt, confident expression, clean-shaven, standing upright with professional demeanor"
                }}
              ]
            }}
            """
            try:
                ...
                resp_s3_5 = await asyncio.wait_for(
                    model_text.generate_content_async(req_content),
                    timeout=api_timeout
                )
                track_text("", resp_s3_5.text)
                ref_data = json.loads(self._clean_json(resp_s3_5.text)).get("references", [])
                with open(os.path.join(session_dir, "stage2_5_references.json"), "w", encoding="utf-8") as f: json.dump(ref_data, f, indent=2)
        ...
        EXISTING REFERENCE ASSETS (MUST BE USED):
        ...
        {{
            ...
            "assets": [
                {{"name": "...", "category": "...", "description": "...", "parent_asset": null, "is_reference": false}},
                ...
            ]
        }}
        """
        track_text(prompt_s3_plan, "")
        # Stage 3 Narrative Planning with timeout and retry logic
        max_retries_s3_plan = 3
        resp_s3_plan = None
        debug_s3_plan = None
        for attempt in range(max_retries_s3_plan):
            try:
                print(f"[SceneGen] Stage 3: Narrative Planning - Sending request to Gemini (Attempt {attempt+1}/{max_retries_s3_plan})...")
                update_report("Stage 3: Narrative & Asset Planning...", 15, f"Developing storyline and asset list... (Attempt {attempt+1}/{max_retries_s3_plan})")
                resp_s3_plan = await asyncio.wait_for(
        ...
        debug_s3_plan = resp_s3_plan.text
                ...
                print(f"[SceneGen] Stage 3: Narrative Planning - Timeout error (Attempt {attempt+1}/{max_retries_s3_plan})...")
                if attempt == max_retries_s3_plan - 1:
                    raise Exception("Stage 3: Narrative planning timed out after 3 attempts. The request might be too complex or there's a connection issue.")
                await asyncio.sleep(5 * (attempt + 1))
            except Exception as e:
                print(f"[SceneGen] Stage 3: Narrative Planning Error (Attempt {attempt+1}/{max_retries_s3_plan}): {e}")
                if attempt == max_retries_s3_plan - 1:
                    raise Exception(f"Stage 3: Failed to generate narrative plan after {max_retries_s3_plan} attempts: {str(e)}")
                await asyncio.sleep(5 * (attempt + 1))
        ...
        # Stage 3 Color Palette with timeout and retry logic
        max_retries_s3 = 3
        resp_s3 = None
        debug_s3 = None
        for attempt in range(max_retries_s3):
            try:
                print(f"[SceneGen] Stage 3: Color Palette - Sending request to Gemini (Attempt {attempt+1}/{max_retries_s3})...")
                update_report("Stage 3: Color Palette...", 17, f"Generating color palette... (Attempt {attempt+1}/{max_retries_s3})")
                resp_s3 = await asyncio.wait_for(
        ...
        debug_s3 = resp_s3.text
                ...
                print(f"[SceneGen] Stage 3: Color Palette - Timeout error (Attempt {attempt+1}/{max_retries_s3})...")
                if attempt == max_retries_s3 - 1:
                    raise Exception("Stage 3: Color palette generation timed out after 3 attempts. There might be a connection issue.")
                await asyncio.sleep(5 * (attempt + 1))
            except Exception as e:
                print(f"[SceneGen] Stage 3: Color Palette Error (Attempt {attempt+1}/{max_retries_s3}): {e}")
                if attempt == max_retries_s3 - 1:
                    raise Exception(f"Stage 3: Failed to generate color palette after {max_retries_s3} attempts: {str(e)}")
                await asyncio.sleep(5 * (attempt + 1))
        track_text("", debug_s3)
        ...
        async def gen_asset_task(asset_data):
            ...
            context_assets_added = []  # Initialize list to track context assets
            
            # 1. Add Parent Asset (Direct Dependency)
            if parent_name and parent_name in asset_library:
                parent_img = asset_library[parent_name]
                input_parts.append(parent_img)
                context_assets_added.append(parent_name)
            ...
            for attempt in range(max_retries):
                try:
                    ...
                    r = await asyncio.wait_for(model_image_gen.generate_content_async(input_parts), timeout=api_timeout)
        ...
        # Initialize completed set with existing assets in library
        completed = set(asset_library.keys())
        
        # For reference assets, verify they exist in asset_library
        for ref_asset in assets_skipped:
            ref_name = ref_asset["name"]
        ...
        pending = {a["name"]: a for a in assets_to_generate}
        ...
        while pending:
            ...
            if not ready:
                print("Stage 5: Cyclic dependency or missing parent. Forcing remaining...")
        ...
        for attempt in range(max_montage_retries):
            ...
            try:
                resp_s6 = await asyncio.wait_for(
                    model_text.generate_content_async([full_prompt, {"mime_type": "audio/wav", "data": audio_bytes}]),
                    timeout=api_timeout
                )
        ...
        async def process_batch(b_idx):
            ...
            try:
                ...
                resp_s7 = await asyncio.wait_for(
                    model_text.generate_content_async(prompt_s7),
                    timeout=api_timeout
                )
...
"""
        ...
        async def refine_scene_prompt(idx, scene, img, start_time):
            ...
            try:
                ...
                resp = await asyncio.wait_for(
                    model_text.generate_content_async([prompt_s9, img]),
                    timeout=api_timeout
                )
        ...
        if render_mode == "Full Render":
            ...
            if valid_videos:
                ...
                if norm_videos:
                    ...
                    # --- Audio Mixing Logic ---
                    # 1. Extract/Generate audio for each clip if mixing is enabled
                    video_audio_track = os.path.join(session_dir, "video_track.wav")
                    has_video_audio = False
                    
                    if mix_native_audio:
                        print("[SceneGen] Mixing native video audio...")
                        audio_segments = []
                        for i, v in valid_videos:
                            seg_audio = os.path.join(session_dir, f"aud_{i:03d}.wav")
                            trim = replicate_tasks[i]["trim_duration"]
                            
                            # Try to extract audio, fallback to silence
                            try:
                                # Check if audio stream exists
                                probe = subprocess.run(
                                    ["ffprobe", "-v", "error", "-select_streams", "a", "-show_entries", "stream=codec_type", "-of", "csv=p=0", v],
                                ...
                                subprocess.run([
                                    ...
                                    "-t", str(trim), "-c:a", "pcm_s16le", seg_audio
                                ], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                        ...
                        if audio_segments:
                            concat_aud_list = os.path.join(session_dir, "concat_audio.txt")
                            with open(concat_aud_list, "w") as f:
                                for a in audio_segments: f.write(f"file '{a.replace(os.sep, '/')}'\n")
                            
                            subprocess.run([
                                "ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", concat_aud_list, 
                                "-c", "copy", video_audio_track
                            ], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                            has_video_audio = True

                    # 2. Final Muxing with Complex Filter
                    # Inputs: 0=Video(silent), 1=OriginalAudio, 2=VideoAudio(optional)
                    cmd = ["ffmpeg", "-y", "-i", silent_path, "-i", original_audio_path]
                    
                    filter_complex = ""
                    if has_video_audio:
                        cmd.extend(["-i", video_audio_track])
                        # Mix 1 and 2
                        filter_complex += f"[1:a]volume={audio_volume}[a1];[2:a]volume={video_volume}[a2];[a1][a2]amix=inputs=2:duration=first:dropout_transition=0[amix]"
                        last_audio_label = "[amix]"
                    else:
                        # Just original audio
                        filter_complex += f"[1:a]volume={audio_volume}[aout_vol]"
                        last_audio_label = "[aout_vol]"
                    
                    # Normalization
                    if normalize_audio:
                        filter_complex += f";{last_audio_label}loudnorm=I=-16:TP=-1.5:LRA=11[a_final]"
                        last_audio_label = "[a_final]"
                    
                    cmd.extend(["-filter_complex", filter_complex, "-map", "0:v", "-map", last_audio_label, "-c:v", "copy", "-c:a", "aac", "-b:a", "192k", "-shortest", final_video_path])
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <details>
                        <summary>🖼️ Generated Assets ({len(data.get("generated_assets", []))})</summary>
                        <div class="details-content">
                            <div class="gallery">
                                {assets_html}
                            </div>
                    ...
                    <details>
                        <summary>🎬 Video Segments ({len(data.get("generated_segments", []))})</summary>
                        <div class="details-content">
...
NODE_DISPLAY_NAME_MAPPINGS = {
    'SceneGenMoviesNode': 'SceneGen - Movies (In Development)',
